...
s = chrome.find_element(By.XPATH, '//input[@id="first-names"] | //input[@id="last-names"]')
...
# //div[@class="col-sm-8 col-sm-offset-2"]/input[@id="checkbox-1"]
# //div/input[@id="checkbox-1"]
# //div/div[2]/input[@type="checkbox"]
# //div/div[2]/input[@type="checkbox"]//parent::div//parent::div//parent::div/div[7]//preceding-sibling::div[1]//preceding-sibling::div[1]//preceding-sibling::div[3]//following-sibling::div[3]
'''
x y axis navigation
cu parent in sus
