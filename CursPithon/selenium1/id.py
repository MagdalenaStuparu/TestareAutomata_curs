...
# Obiectiv: Vrem sa scriem in coloana firstName


# Metoda 1: Salvam elementul intr-o variabila, si prin intermediul variabilei accesam metoda send_keys
first_name_textbox = chrome.find_element(By.ID,"first-name")
first_name_textbox.send_keys("I am a big fluffy parrot")

first_name_textbox.clear()

# Metoda 2: gasim elementul si apelam metoda de scriere direct
chrome.find_element(By.ID,"first-name").send_keys("I am a big fluffy parrot")
...
try:
    ...
    print("button was not visible on the website - test passed")
