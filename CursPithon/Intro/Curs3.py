...
nume_as_list_v0=['M','i','c','h','a','e','l']  #in cazul asta ar avem o lista cu 7 elemente, fiecare element reprezentant o litera

# Accesarea listelor se face prin intermediul parantezelor patrate in interiorul carora se pune indexul dorit
print(nume_as_list_v0[0]) # va returna M, pentru ca la liste indicele incepe de la pozitia 0.
                        # indexul pe care vreau sa il accesez va fi pus intre paranteze patrate
print(nume_as_list_v0[-1])

print(len(nume_as_list_v0)) # len = prescurtarea de la length


print(nume[0:2]) # Afiseaza M (din pozitia 0) si i (din pozitia 1) - string slicing
print(nume_as_list_v0[0:2])  # list indexing
print(nume_as_list_v0[:2]) #  aici mi se vor afisa doua elemente intr-o lista, pentru ca eu accesez o lista


# O lista poate sa contina mai multe tipuri de data
lista_exemplu = [1,34.5,"test",True,False]
...
print(masini[0])  # am accesat masina Trabant pe baza de index

# In cazul in care nu stiu indexul unui element, pot sa il aflu prin intermediul functiei index
...
print(masini[masini.index('Trabant')])  # am accesat masina Trabant pe baza de index
# print() -> printeaza ceva pe ecran
# masini[] -> acceseaza un element pe baza de index
# masini.index('Trabant') -> afla indexul la care se afla masina Trabant
# print(masini[masini.index('Trabant')]) <=> print(masini[0]) <=> print('Trabant') => Trabant
...
nume_as_list = ["Ana","Are","mere","dulci","galbene","si","malaiete"]

print(f"Lista curenta este {nume_as_list}")
literaRemove = nume_as_list.remove('Ana')  # Remove poate sa scoata un caracter din lista pe baza codului ASCII (pe baza caracterului in sine)
literaPop = nume_as_list.pop(5) # Pop poate sa scoata un caracter din lista pe baza indexului.
                                   # Acum am scos un element din lista
                                        # nume_as_list = ["Are","mere","dulci","galbene","si","malaiete"]
                                             # dupa ce am scos cuvantul Ana

print(f"Lista noua dupa inlaturarea cuvantului Ana si a elementului din pozitia 5 este {nume_as_list}")
...
print(f"Lista curenta dupa eliminarea elementelor necesare este {nume_as_list}") # Va printa pe ecran Mihal in urma scoaterii caracterelor e si c
...
# Exemplu de suprascriere la variabile
my_var = 35 # declarare si initializare
my_var = 46 # suprascriere

# lista cu care am ramas in urma schimbarilor de mai sus este ['M', 'i', 'h', 'a', 'e']

nume_as_list_v0[0] = 'a' # nume_as_list[0] este identificarea elementului pe baza de index, "=" reprezinta operatorul de atribuire
                            # si 'a' reprezinta carecterul care va inlocuitor la indexul identificat

print(nume_as_list_v0) # ['a','i','c','h','a','e','l']
nume_as_list_v0[0] = 'r'
print(nume_as_list_v0) # ['r','i','c','h','a','e','l']


# nume_as_list_v0['r'] = 'M' # - Nu putem sa accesam elementul pe baza de ASCII
nume_as_list_v0[nume_as_list_v0.index('r')] = 'M'
print(nume_as_list_v0) # ['M','i','c','h','a','e','l']


# 5. Cum adaugam la index?
#
 # lista cu care am ramas in urma schimbarilor de mai sus este ['M','i','c','h','a','e','l']

# 1. Cerinta: Vrem sa inseram o noua litera la inceputul listei astfel incat sa obtinem lista
                                # ['m','r', 'i', 'h', 'a', 'e']
# 2. Cerinta: Vrem sa inseram o noua litera in pozitia 1 a listei astfel incat sa obtinem lista
                               # ['m','a','r', 'i', 'h', 'a', 'e']

nume_as_list_v0.insert(0,'m')
print(f"Am indeplinit cerinta 1 si am obtinut urmatoarea lista: {nume_as_list_v0} ")
nume_as_list_v0.insert(1,'a')
print(f"Am indeplinit cerinta 2 si am obtinut urmatoarea lista: {nume_as_list_v0} ")
# ['m', 'a', 'M', 'i', 'c', 'h', 'a', 'e', 'l']  <-> ['m', 'a', 'M', 'a', 'i', 'c', 'h', 'a', 'e', 'l']
nume_as_list_v0.insert(3,'a')
nume_as_list_v0.insert(nume_as_list_v0.index('i'),'a')
print(f"lista dupa adaugarea elementului este: {nume_as_list_v0}")


# """
# 6. Cum adaugam la final?

# 1. Cerinta: Vrem sa adaugam un nou caracter la finalul listei
          # astfel incat sa obtinem lista ['m', 'a', 'M', 'a', 'a', 'i', 'c', 'h', 'a', 'e', 'l','a']

nume_as_list_v0.append('a')
print(f"lista dupa append este {nume_as_list_v0}")
"""
...
#      [0]
# ]
lista_in_lista=[1,45,"test",[1,2,3],[0]]
print(lista_in_lista[2])
print(lista_in_lista[3])
print(lista_in_lista[3][1])
...
vocale_set = {'a','e','i','o','u'} # am definit un set care sa contina doar vocale
vocale_lista = ['a','e','i','o','u'] # am definit o lista care sa contina doar vocale
print(vocale_set)
print(vocale_lista)

# 2. Cum accesam elementele unui set? Nu se pot accesa deoarece seturile nu sunt structuri de date ordonate
# print(vocale_set[0]) # Imi va da eroare -  TypeError: 'set' object is not subscriptable
...
# print(f" setul este:{vocale_set['a']}")
# print(vocale_set['a'])

# 3. Cum putem sa adaugam elemente intr-un set?
before = vocale_set # am stocat setul vocale inainte de modificare intr-o variabila numita before
print(before)
vocale_set.add('a')
after = vocale_set
...
# operatorul in este un operator care face o cautare intr-o colectie de elemente atunci cand nu stim exact unde se afla elementul de care avem nevoie
litera = 'e'
if litera in vocale_set:
 print("litera e vocala")
else:
 print("litera e consoana")

# putem adauga un nou caracter in set cu functia add
print(f"Vocalele inainte de adaugare: {vocale_set}")
vocale_set.add('A')  #  valoarea se va adauga pentru ca este scrisa cu litera mare
                        # codul ASCII al literei 'A' este 65 si al literei 'a' este 97
after = vocale_set
lungime = len(vocale_set)
print(f"Vocalele dupa adaugare: {after}. Setul are lungimea de {lungime}")

vocale_set.remove('a')
print(vocale_set)
vocale_set.pop() # functia pop scoate primul element din lista
print(vocale_set)
vocale_set.pop()
print(vocale_set)
...
capitale['Elvetia'] = 'Alba'  # aici nu se face schimbarea cheii ci adaugarea unui nou element prin operatorul de atribuire
print(capitale)
...
print(capitale)
#
# 4. putem sa stergem o informatie? # R: Da, prin intermediul functiei pop
...
print(capitale)
#
# 5. Putem sa concatentam doua dictionare? Da, prin intermediul functiei update
...
# print(capitale)
#
# 6. Putem sa afisam doar CHEILE unui dictionar? R: Da, prin intermediul functiei 'keys'
print(capitale2.keys())
print(capitale.keys())

# 7. Putem sa afisam doar VALORILE unui dictionar? R: Da, prin intermediul functiei 'keys'
    ...
    {"disparuti":
        {
             ...
             "pe_cale_de_disparitie":
                 {
                 "tigri":"mamifere",
                 "ursi_polari":"mamifere",
                 "albine":"insecte",
             }
    }

print(dict_test["disparuti"]["dinozauri"])
print(dict_test["pe_cale_de_disparitie"]["tigri"])
print(dict_test["disparuti"]["bunSimt"])
